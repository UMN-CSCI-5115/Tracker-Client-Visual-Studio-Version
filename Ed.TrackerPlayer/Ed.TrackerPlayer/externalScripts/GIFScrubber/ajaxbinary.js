        ...
        function sendRequest(strURL, fncCallback, fncError, aRange, bAcceptRanges, iFileSize) {
            ...
            if (oHTTP) {
                ...
                oHTTP.addEventListener("error", function () {
                    document.getElementById('loading-message').innerHTML = '<span class="error">Error loading image.</span>';
                    document.getElementById('download-progress').style.display = 'none';
                }, false);
                oHTTP.addEventListener("progress", function (data) {
                    ...
                    document.getElementById("download-progress-bar").style.width = 300 * loaded;
